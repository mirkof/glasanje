...
Ова алатка је наставак на решење које је Богдан Ђукић направио 2017-те године. Оригинални код тог првобитног решења можете нађи [овде](https://github.com/bdjukic/glasajDijasporo). Код тренутног решења је досупан кликом на дугме "View project on Github" у горњем делу ове странице.
